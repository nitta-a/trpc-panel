...
Currently, tRPC panel supports tRPC v11 and only works with zod input schemas. With its current design it would be feasible to easily add support for other input validators as well.
